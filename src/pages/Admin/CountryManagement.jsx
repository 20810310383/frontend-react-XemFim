...
const CountryManagement = () => {
  ...
  const updateCountry = async (id) => {
    //Cập nhật quốc gia
    try {
      await axios.put(`${config.API_URL}/countries/${id}`, {
        name: editingCountryName,
      });
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="flex justify-between items-center mt-6">
        ...
        <button
          onClick={() =>
            setPage((prev) =>
              prev < Math.ceil(countries.length / itemsPerPage)
                ? prev + 1
                : prev
            )
          }
